...
共享例程(r0=原方法, r4=child):
  ...
  r14 = 0x086ed694               ; 硬编码 main ← 这就是那个缺陷(见 §10):
...
| 主对象 CPSoundPresCtrl | 堆单例 —— ⚠️ **每次开机都漂**(见过 0x086ec01c / 0x086ed694 / 0x086ed01c / 0x086ef01c / 0x0872d694 / 0x0872f01c)。**绝不能硬编码**:用 `main = *(*(*(child+0x38)+0x08)+0x70)` 自派生(见 §10)。身份校验:`*(main) == 0x085c4c5c` |
