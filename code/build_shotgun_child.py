#!/usr/bin/env python3
"""shotgun-CHILD: instrument child-vtable (0x085700e0, 5 methods). main hardcoded 0x086ed694 (deterministic). Same guard/fix as main-shotgun. all main-vtable slots (0x085c4c5c) so that whichever one
...
VT=0x085700e0   # child vtable
CODE=0x0856484c          # RX dead zone (shared with main-shotgun region, fmboot base=0)
...
def build(binpath):
    ...
    prog+=[('pc','Lmain',14)]                             # r14 = 0x086ed694 (hardcoded main)
    ...
    LITS=['Lx1f0','Lx94c','Lesc','Llo','Lmain']; litaddr={}; p=lit_base
    ...
    lv={'Lx1f0':0x1f0,'Lx94c':0x94c,'Lesc':ESC,'Llo':0x08600000,'Lmain':0x086ed694}
