...
- `dev/build_shotgun_child_chain.py` — **解法**:child-vtable cave,`main` 自派生
- `dev/validate_shotgun_child_chain.py` — sh4emu 对真 `-2` 快照的证明(T1开火 / T2安全 / T3不fault)
- `dev/build_shotgun_child.py` — 它的前身,作为参照基线保留(`main` 写死)
